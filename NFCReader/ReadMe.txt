================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: NFCReader プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した NFCReader には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには NFCReader アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
NFCReader.h
   ...
   CNFCReaderApp アプリケーション クラスを宣言します。

NFCReader.cpp
   これは、アプリケーション クラス CNFCReaderApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\NFCReader.ico
   ...
   アイコンはメイン リソース ファイル NFCReader.rc に含まれていま
   す。
...
NFCReaderDlg.h, NFCReaderDlg.cpp - ダイアログ
   これらのファイルは CNFCReaderDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な NFCReader.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   NFCReader.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
